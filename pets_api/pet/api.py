...
from pets_api.app.decorstors import app_required
...
class PetApi(MethodView):
    ...
    pets = [
        {'id': 1, 'name': u'Mac', 'links': [
            {'rel': 'self', 'href': '/pets/1'}
        ]},
        {'id': 2, 'name': u'Leo', 'links': [
            {'rel': 'self', 'href': '/pets/2'}
        ]},
        {'id': 3, 'name': u'Brownie', 'links': [
            {'rel': 'self', 'href': '/pets/3'}
        ]},
    ]
    ...
    def post(self):
        ...
        pet = {
            ...
            'links': [{'rel': 'self', 'href': f'/pets/{str(len(self.pets) + 1)}'}]
        }
